#knight moves puzzle
#given inputs of integers src, dest, which represent cells on a chess board, this function ouputs the mimimum number of moves a knight will take to travel such a path
